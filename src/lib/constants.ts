export const VACCINATION_FORM_URL =
...
/** Official doctor portrait used across trust surfaces */
export const DOCTOR_PHOTO_SRC = "/images/dr-chaitanya.jpg";
export const DOCTOR_PHOTO_ALT =
  "Dr. N. Chaitanya Krishna, Consultant Paediatrician & Intensivist";
