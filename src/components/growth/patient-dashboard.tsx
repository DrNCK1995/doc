...
const TAB_VALUES = ["charts", "visits", "enter", "vaccinations", "export"] as const;
type TabValue = (typeof TAB_VALUES)[number];

function resolveTab(raw: string | null): TabValue {
  if (raw === "follow-up" || raw === "enter") return "enter";
...
export function PatientDashboard() {
  ...
  function setTab(next: string) {
    ...
    if (value === "charts") url.searchParams.delete("tab");
  ...
  if (error || !patient) {
    return (
      <Card>
        ...
        <CardContent>
          <Button asChild>
            <Link href="/growth">Back to children</Link>
          </Button>
        </CardContent>
      </Card>
    );
    ...
    <div className="space-y-6">
      ...
      <Tabs value={tab} onValueChange={setTab}>
        <TabsList className="no-print">
          ...
          <TabsTrigger value="enter">Enter growth</TabsTrigger>
        ...
        <TabsContent value="enter">
          <Card>
            <CardHeader>
              <CardTitle className="text-xl">Enter growth parameters</CardTitle>
              <CardDescription>
                Fill only what you measured. Interpretation uses the values you
                provide.
              </CardDescription>
            </CardHeader>
            <CardContent>
